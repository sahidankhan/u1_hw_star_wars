...
empire mv death_star/millenium_falcon/* death_star
...
death_star  mv luke_skywalker.txt millenium_falcon
death_star mv chewbacca.txt millenium_falcon
death_star mv hans_solo.txt millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
star_wars mv empire/death_star/millenium_falcon rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
star_wars mv empire/death_star/darth_vader.txt empire
